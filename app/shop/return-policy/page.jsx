...
const ReturnPolicyPage = () => {
  ...
  return (
        <div className="leading-8 px-5 lg:px-36 xl:px-52 py-14 bg-gray-100">
            ...
            <h3 className="text-xl font-semibold mt-8 text-dcam-black">3. Receipt Requirement</h3>
            <p>Please provide a receipt or proof of purchase with your return.</p>
            <h3 className="text-xl font-semibold mt-8 text-dcam-black">4. Refund Method</h3>
            ...
            <h3 className="text-xl font-semibold mt-8 text-dcam-black">5. Return Shipping Costs</h3>
            ...
            <h3 className="text-xl font-semibold mt-8 text-dcam-black">6. Non-Returnable Items</h3>
            <p>The following items cannot be returned:</p>
            <ul className="list-disc list-inside">
                <li>sale items</li>
                <li>digital products</li>
            </ul>
            <h3 className="text-xl font-semibold mt-8 text-dcam-black">7. Return Process</h3>
            ...
            <h3 className="text-xl font-semibold mt-8 text-dcam-black">8. Exchanges</h3>
            <p>We only replace items if they are defective or damaged. If you need to exchange an item for the same product, please visit our store.</p>
        </div>
    )
}
