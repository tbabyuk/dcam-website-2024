    ...
    return (
        <section className="px-5 lg:px-36 xl:px-52 py-20">
            <div className="flex-col leading-10">
                <div className="mb-5">
                    <h2 className="font-ovo text-dcam-reg-orange text-3xl font-semibold text-center pb-3 border-b-2 border-b-gray-300">{fullName}</h2>
                    {title && <h4 className="font-ovo text-dcam-reg-orange text-xl font-semibold text-center pt-3">{title}</h4>}
                    <h4 className="font-ovo text-xl font-semibold text-center pt-3 pb-8">Teacher: <span className=" font-light">{instrumentList}</span></h4>
                </div>
